...
public class SpaceBackground extends AbstractEntity {
    ...
    public void update() {
        ...
        float deslocCalc = speed*manager.getLastFrameTime();
    ...
    public void draw(J2DCanvas j2d) {
        ...
        j2d.drawSprite(background, manager.getWidth()/2,(background.getSizes().v1/2*-1)+1 + deslocA);
        j2d.drawSprite(background, manager.getWidth()/2,(background.getSizes().v1/2*-3)+1 + deslocA);
        ...
        //j2d.drawImage(star2, 0.0f+star2.getSizes().v0/2,desloc*4);




        //j2d.drawImage(star3, 0.0f+star3.getSizes().v0/2,desloc*8);
    }
}
